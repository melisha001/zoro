...
export default function CoursePage({ onOpenEnquire }) {
  const [selectedCourseId, setSelectedCourseId] = useState('abacus-3');
                ...
                <div className="md:col-span-7 space-y-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-200/60 text-xs">
                    <div>
                      ...
                      <div className="font-extrabold text-slate-800 text-sm mt-0.5">{selectedCourse.duration}</div>
                    </div>
                    <div>
                      <div className="text-slate-400 font-semibold">Mode</div>
                      <div className="font-extrabold text-slate-800 text-sm mt-0.5">{selectedCourse.mode}</div>
                    </div>
                    <div>
                      <div className="text-slate-400 font-semibold">Age Group</div>
                      <div className="font-extrabold text-slate-800 text-sm mt-0.5">{selectedCourse.ageGroup}</div>
                    </div>
                    <div>
                      <div className="text-slate-400 font-semibold">Certificate</div>
                      <div className="font-extrabold text-slate-800 text-sm mt-0.5">{selectedCourse.certificate}</div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200/80 shadow-md p-6 sm:p-8 space-y-6">
              ...
              {activeTab === 'overview' && (
                <div className="space-y-4">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">{selectedCourse.overview}</p>
                </div>
              )}
